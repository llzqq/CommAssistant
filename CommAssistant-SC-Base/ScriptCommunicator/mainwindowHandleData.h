...
public slots:
    ...
    ///Bridge helper for non-main-interface receive data.
    void bridgeDataReceivedSlot(QByteArray data, bool isFromCan);

    ///Bridge helper for non-main-interface sent data.
    void bridgeDataSentSlot(QByteArray data, bool success, bool isFromCan);
